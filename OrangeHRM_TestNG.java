...
public class OrangeHRM_TestNG 
{
	WebDriver driver;
	  ...
	  @Test(priority = 2)														//CorperateBranding
		  public void Admin() throws InterruptedException, AWTException 
	  {
		 ...
		 cl.click();
	      ...
	      StringSelection str = new StringSelection("C:\\Users\\HP\\Downloads\\staffoutput.csv");
	      ...
	      Robot rba = new Robot();
	      // copying File path to Clipboard
	      StringSelection strr = new StringSelection("C:\\Users\\HP\\Downloads\\staffoutput.csv");
	      ...
	      // copying File path to Clipboard
	      StringSelection strrr = new StringSelection("C:\\Users\\HP\\Downloads\\staffoutput.csv");
	  ...
	  @Test(priority = 3)															//JOB
		  ...
		  driver.findElement(By.xpath("//span[.='Admin']")).click();
	        ...
	        driver.findElement(By.xpath("(//input[@class='oxd-input oxd-input--active'])[2]")).sendKeys("Automation testing");
	        ...
	        driver.findElement(By.xpath("//textarea[@placeholder='Add note']") ).sendKeys("basic of core java");
	        Thread.sleep(1000);
	  ...
	  public void Workshift() throws InterruptedException {
	      ...
	      Thread.sleep(1000);
	      driver.findElement(By.xpath("//input[@placeholder='Type for hints...']")).sendKeys("better Job");
	      driver.findElement(By.xpath("//button[@type='submit']")).click();
	      Thread.sleep(1000);
	  }
	  ...
	  public void Generalinfo() throws InterruptedException, AWTException {
	    ...
	    //Thread.sleep(5000);
	    //driver.findElement(By.xpath("(//input[@class='oxd-input oxd-input--active'])[3]")).sendKeys("raichur");
	  ...
	  public void Generalinfon() throws InterruptedException, AWTException{
	      ...
	      Thread.sleep(1000);
	      driver.findElement(By.xpath("(//input[@class='oxd-input oxd-input--active'])[1]")).sendKeys("dDDD");
	      Thread.sleep(1000);
	      driver.findElement(By.xpath("(//input[@class='oxd-input oxd-input--active'])[2]")).sendKeys("445");
	      Thread.sleep(1000);
	      driver.findElement(By.xpath("(//input[@class='oxd-input oxd-input--active'])[3]")).sendKeys("56215");
	      Thread.sleep(1000);
	      driver.findElement(By.xpath("(//input[@class='oxd-input oxd-input--active'])[4]")).sendKeys("56215");
	      Thread.sleep(1000);
	      driver.findElement(By.xpath("(//input[@class='oxd-input oxd-input--active'])[5]")).sendKeys("22235");
	      Thread.sleep(1000);
	      driver.findElement(By.xpath("(//input[@class='oxd-input oxd-input--active'])[6]")).sendKeys("");
	      Thread.sleep(2000);
	      driver.findElement(By.xpath("(//input[@class='oxd-input oxd-input--active'])[7]")).sendKeys("IDSMT");
	      Thread.sleep(1000);
	      driver.findElement(By.xpath("(//input[@class='oxd-input oxd-input--active'])[8]")).sendKeys("1-4-1309");
	      Thread.sleep(1000);
	      driver.findElement(By.xpath("(//input[@class='oxd-input oxd-input--active'])[9]")).sendKeys("");
	      Thread.sleep(1000);
	      driver.findElement(By.xpath("(//input[@class='oxd-input oxd-input--active'])[11]")).sendKeys("66666");
	      Thread.sleep(2000);
	  ...
	  public void Performance() throws InterruptedException {
	      ...
	      Thread.sleep(1000);
	      /*driver.findElement(By.xpath("(//input[@placeholder='yyyy-mm-dd'])[1]")).sendKeys("2023-08-04");
	      driver.findElement(By.xpath("(//input[@placeholder='yyyy-mm-dd'])[2]")).sendKeys("2023-08-06");
	      Thread.sleep(1000);
	      driver.findElement(By.xpath("(//input[@placeholder='yyyy-mm-dd'])[3]")).sendKeys("2023-08-08");*/
	      driver.findElement(By.xpath("(//button[@type='button'])[4]")).click();
	      Thread.sleep(1000);
	  }
	  ...
	  public void Pim() throws InterruptedException {
	      ...
	      driver.findElement(By.name("lastName")).sendKeys("Raichur");
	      driver.findElement(By.xpath("(//input[@class='oxd-input oxd-input--active'])[2]")).sendKeys("1256");
	      Thread.sleep(1000);
	      //add pic
	  ...
	  public void Qualification() {
	      ...
	      driver.findElement(By.xpath("(//button[@type='button'])[3]")).click();
	      driver.findElement(By.xpath("(//input[@class='oxd-input oxd-input--active'])[2]")).sendKeys("Kannada");
	      driver.findElement(By.xpath("//button[@type='submit']")).click();
	      ...
	      driver.findElement(By.xpath("(//button[@type='button'])[3]")).click();
	      driver.findElement(By.xpath("(//input[@class='oxd-input oxd-input--active'])[2]")).sendKeys("NIT,Raichur");
	      driver.findElement(By.xpath("//button[@type='submit']")).click();
	  ...
	  public void Req() throws InterruptedException, AWTException {
		  driver.findElement(By.xpath("(//span[.='Recruitment'])[1]")).click();
		   ...
		   //realase
		    ...
		    driver.findElement(By.xpath("//input[@placeholder='Enter comma seperated words...']")).sendKeys("heroji");
